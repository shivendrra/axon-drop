...
void scalar_mul_tensor_cpu(Tensor* a, float b, Tensor* out);
void scalar_div_tensor_cpu(Tensor* a, float b, Tensor* out);
void tensor_div_scalar_cpu(Tensor* a, float b, Tensor* out);
void scalar_pow_tensor_cpu(float base, Tensor* a, Tensor* out);
void tensor_pow_scalar_cpu(Tensor* a, float b, Tensor* out);
...
void ones_like_tensor_cpu(Tensor* a, Tensor* out);
void zeros_like_tensor_cpu(Tensor* a, Tensor* out);
