...
__global__ void sum_tensor_cuda_kernel(float* a, Tensor* out);
...
__global__ void max_tensor_cuda_kernel(float* a, Tensor* out);
...
__global__ void min_tensor_cuda_kernel(float* a, Tensor* out);
